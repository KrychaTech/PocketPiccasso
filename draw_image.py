...
render("Pocket Picasso",'slant')
print("Made by KrychaTech, https://github.com/KrychaTech\nCurrently, this program supports .png and .jpg files.\n")
print("What is the name of a file?")
PNG_PATH = input("name of the file (with extension): ")
print("What is the Width of the image?")
width = input("Width: ")
print("What is the Height of the image?")
height = input("Height: ")
...
#                     queue.append((i-1, j))
#                     # prev_pos = check_draw(i-1, j, WIDTHprev_pos)
#                     visited[i-1][j] = True
